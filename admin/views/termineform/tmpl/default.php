...
if (isset($catidAlltime)) { ?>
	...
	<?php } ?>
		...
		<tr>
			...
			<td>
				<?php if ($this->termine->startdate < '1970-01-01') {
				    $this->termine->startdate = $today;
				}
echo CLMForm::calendar($this->termine->startdate, 'startdate', 'startdate', '%Y-%m-%d', array('class' => 'text_area', 'size' => '12',  'maxlength' => '19')); ?>
				...
				<span><input type="checkbox" id='allday' name='allday' <?php if ($this->termine->allday == 1) {
				    echo " checked='checked' ";
				} ?> value="<?php echo $this->termine->allday; ?>" /></span>
		...
		<tr>
			...
			<td>
				<?php if ($this->termine->enddate < '1970-01-01') {
				    $this->termine->enddate = '1970-01-01';
				} //$today;
if ($this->termine->enddate == '1970-01-01') {
    $this->termine->endtime = '00:00:00';
} //neu
echo CLMForm::calendar($this->termine->enddate, 'enddate', 'enddate', '%Y-%m-%d', array('class' => 'text_area', 'size' => '12',  'maxlength' => '19')); ?>
				...
				<span><input type="checkbox" id='noendtime' name='noendtime' <?php if ($this->termine->noendtime == 1) {
				    echo " checked='checked' ";
				} ?> value="<?php echo $this->termine->noendtime; ?>" /></span>
