...
<!--		<select name="runden_modus" id="runden_modus" class="js-example-basic-single" value="<?php echo $row->runden_modus; ?>" size="1"> -->
		...
		<option value="1" <?php if ($row->runden_modus == 1) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_PAIRING_MODE_2');?></option>
		<option value="2" <?php if ($row->runden_modus == 2) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_PAIRING_MODE_3');?></option>
		<option value="3" <?php if ($row->runden_modus == 3) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_PAIRING_MODE_4');?></option>
		<option value="4" <?php if ($row->runden_modus == 4) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_PAIRING_MODE_5');?></option>
		<option value="5" <?php if ($row->runden_modus == 5) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_PAIRING_MODE_6');?></option>
		</select>
	</td>
	<td nowrap="nowrap">
...
<!--		<select name="tiebr1" id="tiebr1" class="js-example-basic-single" value="<?php echo $row->tiebr1; ?>" size="1"> -->
		...
		<!--<option>- wählen -</option>-->
		<option value="0" <?php if ($row->tiebr1 == 0) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_SELECT_TIEBR_0');?></option>
		<option value="1" <?php if ($row->tiebr1 == 1) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_1');?></option>
		<option value="11" <?php if ($row->tiebr1 == 11) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_11');?></option>
		<option value="2" <?php if ($row->tiebr1 == 2) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_2');?></option>
		<option value="12" <?php if ($row->tiebr1 == 12) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_12');?></option>
		<option value="7" <?php if ($row->tiebr1 == 7) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_7');?></option>
		<option value="17" <?php if ($row->tiebr1 == 17) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_17');?></option>
		<option value="8" <?php if ($row->tiebr1 == 8) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_8');?></option>
		<option value="18" <?php if ($row->tiebr1 == 18) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_18');?></option>
		<option value="23" <?php if ($row->tiebr1 == 23) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_23');?></option>
		<option value="4" <?php if ($row->tiebr1 == 4) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_4');?></option>
		<option value="5" <?php if ($row->tiebr1 == 5) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_5');?></option>
		<option value="9" <?php if ($row->tiebr1 == 9) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_9');?></option>
		<option value="10" <?php if ($row->tiebr1 == 10) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_10');?></option>
		<option value="3" <?php if ($row->tiebr1 == 3) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_3');?></option>
		<option value="25" <?php if ($row->tiebr1 == 25) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_25');?></option>
		<option value="51" <?php if ($row->tiebr1 == 51) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_51');?></option>
		</select>
	</td>
	<td nowrap="nowrap">
...
<!--		<select name="tiebr2" id="tiebr2" class="js-example-basic-single" value="<?php echo $row->tiebr2; ?>" size="1"> -->
		...
		<!--<option>- wählen -</option>-->
		<option value="0" <?php if ($row->tiebr2 == 0) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_SELECT_TIEBR_0');?></option>
		<option value="1" <?php if ($row->tiebr2 == 1) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_1');?></option>
		<option value="11" <?php if ($row->tiebr2 == 11) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_11');?></option>
		<option value="2" <?php if ($row->tiebr2 == 2) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_2');?></option>
		<option value="12" <?php if ($row->tiebr2 == 12) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_12');?></option>
		<option value="7" <?php if ($row->tiebr2 == 7) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_7');?></option>
		<option value="17" <?php if ($row->tiebr2 == 17) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_17');?></option>
		<option value="8" <?php if ($row->tiebr2 == 8) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_8');?></option>
		<option value="18" <?php if ($row->tiebr2 == 18) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_18');?></option>
		<option value="23" <?php if ($row->tiebr2 == 23) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_23');?></option>
		<option value="4" <?php if ($row->tiebr2 == 4) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_4');?></option>
		<option value="5" <?php if ($row->tiebr2 == 5) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_5');?></option>
		<option value="9" <?php if ($row->tiebr2 == 9) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_9');?></option>
		<option value="10" <?php if ($row->tiebr2 == 10) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_10');?></option>
		<option value="3" <?php if ($row->tiebr2 == 3) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_3');?></option>
		<option value="25" <?php if ($row->tiebr2 == 25) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_25');?></option>
		<option value="51" <?php if ($row->tiebr2 == 51) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_51');?></option>
		</select>
	</td>
...
<!--		<select name="tiebr3" id="tiebr3" class="js-example-basic-single" value="<?php echo $row->tiebr3; ?>" size="1"> -->
		...
		<!--<option>- wählen -</option>-->
		<option value="0" <?php if ($row->tiebr3 == 0) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_SELECT_TIEBR_0');?></option>
		<option value="1" <?php if ($row->tiebr3 == 1) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_1');?></option>
		<option value="11" <?php if ($row->tiebr3 == 11) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_11');?></option>
		<option value="2" <?php if ($row->tiebr3 == 2) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_2');?></option>
		<option value="12" <?php if ($row->tiebr3 == 12) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_12');?></option>
		<option value="7" <?php if ($row->tiebr3 == 7) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_7');?></option>
		<option value="17" <?php if ($row->tiebr3 == 17) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_17');?></option>
		<option value="8" <?php if ($row->tiebr3 == 8) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_8');?></option>
		<option value="18" <?php if ($row->tiebr3 == 18) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_18');?></option>
		<option value="23" <?php if ($row->tiebr3 == 23) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_23');?></option>
		<option value="4" <?php if ($row->tiebr3 == 4) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_4');?></option>
		<option value="5" <?php if ($row->tiebr3 == 5) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_5');?></option>
		<option value="9" <?php if ($row->tiebr3 == 9) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_9');?></option>
		<option value="10" <?php if ($row->tiebr3 == 10) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_10');?></option>
		<option value="3" <?php if ($row->tiebr3 == 3) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_3');?></option>
		<option value="25" <?php if ($row->tiebr3 == 25) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_25');?></option>
		<option value="51" <?php if ($row->tiebr3 == 51) {
		    echo 'selected="selected"';
		} ?>><?php echo JText::_('MTURN_TIEBR_51');?></option>
		</select>
	</td>
