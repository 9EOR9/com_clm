...
if ($liga[0]->mail > 0) {
    ...
    if (isset($mannschaft[0]->mf_email) and $mannschaft[0]->mf_email > '') {
		...
		<tr>
		  <td>';
        if ($erstmeldung == 1) {
            $body_html_mf .= JText::_('CLUB_LIST_MAIL_MF1');
        } else {
            $body_html_mf .= JText::_('CLUB_LIST_MAIL_MF1A');
        }
        $body_html_mf .= '</td>
  		</tr>
		<tr>
    ...
    if ($sl_mail == 1 and isset($liga[0]->sl_email) and $liga[0]->sl_email > '') {
		...
		<tr>';
        if ($erstmeldung == 1) {
            $body_html_sl .= '<td>'.JText::_('CLUB_LIST_MAIL_SL1').'</td>';
        } else {
            $body_html_sl .= '<td>'.JText::_('CLUB_LIST_MAIL_SL1A').'</td>';
        }
        $body_html_sl .= '</tr>
		<tr>
    ...
    if ($bcc_mail != "") {
		...
		<tr>';
        if ($erstmeldung == 1) {
            $body_html_ad .= '<td>'.JText::_('CLUB_LIST_MAIL_AD1').'</td>';
        } else {
            $body_html_ad .= '<td>'.JText::_('CLUB_LIST_MAIL_AD1A').'</td>';
        }
        $body_html_ad .= '</tr>
		<tr>
...
if ($countmail > 0) {
    $msg .= JText::_('CLUB_LIST_SEND_MAIL');
}
